...
const ToolStripItemSpec kSpecs[] = {
    {ImgViewerAction::EditSelect, ImgViewerStringId::EditSelect, ImgViewerStringId::SelectEditObjects, L"edit-select", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kSelectIcon},
    {ImgViewerAction::EditPixelSelect, ImgViewerStringId::PixelSelect, ImgViewerStringId::SelectPixels, L"edit-pixel-select", ToolStripItemVisual::PathIcon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", L"", &icons::kRegionScreenshotIcon},
    {ImgViewerAction::EditPen, ImgViewerStringId::EditPen, ImgViewerStringId::PenAnnotation, L"edit-pen", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kPenIcon},
    {ImgViewerAction::EditShape, ImgViewerStringId::EditShape, ImgViewerStringId::ShapeAnnotation, L"edit-shape", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kShapeIcon},
    {ImgViewerAction::EditText, ImgViewerStringId::EditText, ImgViewerStringId::TextAnnotation, L"edit-text", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kTextIcon},
    {ImgViewerAction::EditCrop, ImgViewerStringId::EditCrop, ImgViewerStringId::CropImage, L"edit-crop", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kCropIcon},
    {ImgViewerAction::EditRotateClockwise, ImgViewerStringId::EditRotateClockwise, ImgViewerStringId::RotateEditClockwise, L"edit-rotate-clockwise", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kRotateIcon},
    {ImgViewerAction::EditUndo, ImgViewerStringId::UndoEdit, ImgViewerStringId::UndoEdit, L"edit-undo", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kUndoIcon},
    {ImgViewerAction::EditRedo, ImgViewerStringId::RedoEdit, ImgViewerStringId::RedoEdit, L"edit-redo", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kRedoIcon},
    {ImgViewerAction::SaveImageAs, ImgViewerStringId::SaveAs, ImgViewerStringId::SaveEditedImageAsPng, L"edit-save-as", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kSaveIcon},
    {ImgViewerAction::ToggleEditMode, ImgViewerStringId::ExitEditMode, ImgViewerStringId::ExitEditMode, L"edit-exit", ToolStripItemVisual::Icon, {}, 0.0f, ImgViewerShapeKind::Rectangle, L"", kExitIcon},
};
