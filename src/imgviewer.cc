...
std::unique_ptr<ScriptView> CreateMainUi(script::QuickJsRuntime& engine, ImgViewerUi** main_ui)
{
...
ImgViewerContext::ImgViewerContext() :
    script_engine(std::make_unique<script::QuickJsRuntime>()),
...
void SyncActionStates(ImgViewerContext* context)
{
    ...
    static constexpr std::array kSyncActions{
        ...
        ImgViewerAction::CaptureRegion,
        ImgViewerAction::OpenSettings,
        ImgViewerAction::OpenAbout,
        ...
        ImgViewerAction::ToggleEditMode,
        ImgViewerAction::EditSelect,
        ImgViewerAction::EditPixelSelect,
        ImgViewerAction::EditPen,
        ImgViewerAction::EditShape,
        ImgViewerAction::EditText,
        ImgViewerAction::EditCrop,
        ImgViewerAction::EditCancelCrop,
