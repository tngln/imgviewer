...
constexpr float kTestButtonWidth = 156.0f;
constexpr float kStatusTextTopGap = 12.0f;
constexpr float kStatusTextHeight = 40.0f;
constexpr float kStatusTextRightPadding = 120.0f;
